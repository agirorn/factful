...
module.exports = {
  ...
  test_settings: {
     ...
     *
     * Please set the username and access key by setting the environment
     * variables:
     * - BROWSERSTACK_USER
     * - BROWSERSTACK_KEY
    ...
    /*
     * Configuration for when using the Selenium service, either locally or
     * remote, like Selenium Grid
     */
    selenium: {
